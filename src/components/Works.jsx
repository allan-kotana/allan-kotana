  ...
  <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
   <Tilt options={{
    ...
    speed: 450
     ...
     <div onClick={() => window.open(source_code_link, "blank")} className="
     black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer">
      <img src={github} alt="github" className="w-1/2 h-1/2 object-contain" />
     </div>
     <div onClick={() => window.open(view_link, "blank")} className="
     black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer">
      <img src={eye} alt="github" className="w-1/2 h-1/2 object-contain" />
     </div>
     </div>
     </div>
     <div className="mt-5">
...
const Works = () => {
  return (
    ...
    <div className="w-full flex">
        <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-3
